...
<head>
    ...
    <title>Sekolahku: Tampilkan Pendaftar</title>
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="baru.png" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
...
<!------------------ Pisahin ------------------->
                                    ...
                                    <div class="table-responsive" style="overflow-x:hidden;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                <label>Umur</label>
                                                <input name="umur" type="text" class="form-control" maxlength="5" value="<?php echo $ambil['umur']?>" disabled>
                                            </div>
                                            </div>
                                            <div class="col">
                                            <div class="form-group">
                            ...
                            <div class="card-body">
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive" style="overflow-x:hidden;">
                                        ...
                                        <a href="report.php?u=<?php echo $ambil['umur']?>" class="btn btn-primary">Lihat Bukti Pendaftaran</a>
                                        </div>
        ...
        <footer>
            <div class="footer-area">
                <p>Designed by Anissa Puspitasari💖 NIM 202251173</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
